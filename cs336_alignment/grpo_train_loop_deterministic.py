...
def grpo_train_loop(config: GRPOConfig):
    ...
    experiment_name = f"length_normalize_{config.length_normalization_strategy}_grpo_{config.loss_type}_batch_{config.rollout_batch_size}_group_{config.group_size}_lr_{config.learning_rate}"
    wandb.init(
